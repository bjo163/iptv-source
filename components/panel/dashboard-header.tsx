...
import { Bell, Search, Settings, User, Zap, LogOut, Home } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-full px-6">
        ...
        <div className="flex items-center space-x-4">
          {/* Home */}
          <Button onClick={goToHome} variant="ghost" size="icon" className="text-hud-primary hover:bg-hud-primary/10">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-hud-bg border-hud-border">
              ...
              <DropdownMenuItem onClick={goToClient} className="text-hud-primary hover:bg-hud-primary/10">
